...
// private static final Pose2d initialPose = new Pose2d(0, 0, new
// Rotation2d(0));
...
// Logger.recordOutput("Gyrometer/Heading",
// Math.IEEEremainder(getHeading().getRadians(), 2 * Math.PI));
...
// return new Pose2d(-getPose().getX(), -getPose().getY(),
// getPose().getRotation());
// }
...
// // return gyro.getRotation3d().unaryMinus(); <-- if we need the negative
// version
// }
