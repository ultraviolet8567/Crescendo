...
// // currently at 3 ks -> to decrease to 2, delete every instance of "k3" and
// "cluster3"
...
// private List<Transform3d> cluster1 = new ArrayList<Transform3d>(), cluster2 =
// new ArrayList<Transform3d>(),
...
// return k1;
// } else if (cluster1.size() > cluster2.size() && cluster3.size() >
// cluster1.size()) {
// return k3;
// } else {
// return k2;
...
// return new Transform3d(x / cluster.size(), y / cluster.size(), z /
// cluster.size(),
// new Rotation3d(roll / cluster.size(), pitch / cluster.size(), yaw /
// cluster.size()));
// }
// }
...
// return Math.pow(difference.getX(), 2) + Math.pow(difference.getY(), 2) +
...
// // reset kmeans
// public void clean() {
// k1 = new Transform3d(Math.random() * 10, Math.random() * 10, Math.random() *
// 10, new Rotation3d());
// k2 = new Transform3d(Math.random() * 10, Math.random() * 10, Math.random() *
// 10, new Rotation3d());
// k3 = new Transform3d(Math.random() * 10, Math.random() * 10, Math.random() *
// 10, new Rotation3d());
