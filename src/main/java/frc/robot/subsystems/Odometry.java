...
public class Odometry extends SubsystemBase {
	...
	// int centerSpeakerTagID = (DriverStation.getAlliance().orElse(Alliance.Blue)
	// == Alliance.Blue) ? 7 : 4;

	// return
	// getPose().minus(fieldLayout.getTagPose(centerSpeakerTagID).get().toPose2d()).getRotation();
	// }
	...
	// swerve.getModulePositions(), pose);
	// }
