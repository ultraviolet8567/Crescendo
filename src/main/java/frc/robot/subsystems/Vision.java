...
// estimatorNu = new PhotonPoseEstimator(fieldLayout,
// PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, cameraNu,
// Cameras.robotToCameraNu);
// estimatorXi = new PhotonPoseEstimator(fieldLayout,
// PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, cameraXi,
...
// // Transform3d poseTransformAlternate =
...
// /*
// * THIS CODE IS IN NEED OF COMPATIBILITY CHANGES CODE PROPERTIES: 1) This uses
// * an XYZ system where Z is the up axis 2) Purely mathematical, no interface
// * with data from the robot 3) Completely untested, uses math imported from
// * https://www.desmos.com/3d/606011a56d
// */
// public void setPose() {
// // Interface code
// }
...
// public double solveShooterRot(double xDiff, double zDiff, double exitVel,
// boolean isUpper) {
// //
