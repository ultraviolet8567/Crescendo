...
// /*
// * Initialize all components here, as well as any one-time logic to be
// completed
// * on boot-up
// */
...
// return false; // see if z position changes much? or if the robot tilts a lot
// use angle (x/y?)
// }
...
// return io.leftClimberPastBackLimit() && voltage >= 0 ||
// io.leftClimberPastFrontLimit() && voltage <= 0;
// }

// public boolean rightClimberGoingIntoRange(double voltage) {
// return io.rightClimberPastBackLimit() && voltage >= 0 ||
// io.rightClimberPastFrontLimit() && voltage <= 0;
// }
