...
public class ClimberIOSparkMax implements ClimberIO {
	...
	public ClimberIOSparkMax() {
		...
		leftRelativeEncoder.setPositionConversionFactor(1.0 / ClimberConstants.kClimberPositionReduction * 2 * Math.PI);
		leftRelativeEncoder.setVelocityConversionFactor(1.0 / ClimberConstants.kClimberVelocityReduction * 2 * Math.PI);

		leftAbsoluteEncoder = new DutyCycleEncoder(ClimberConstants.kLeftClimberAbsoluteEncoderPort);
		...
		rightRelativeEncoder
				.setPositionConversionFactor(1.0 / ClimberConstants.kClimberPositionReduction * 2 * Math.PI);
		rightRelativeEncoder
				.setVelocityConversionFactor(1.0 / ClimberConstants.kClimberVelocityReduction * 2 * Math.PI);

		rightAbsoluteEncoder = new DutyCycleEncoder(ClimberConstants.kLeftClimberAbsoluteEncoderPort);
	}
