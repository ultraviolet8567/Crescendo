...
// leftClimberEncoder.setPositionConversionFactor(1.0 /
// ClimberConstants.kClimberPositionReduction * 2 * Math.PI);
// leftClimberEncoder.setVelocityConversionFactor(1.0 /
...
// rightClimberEncoder.setPositionConversionFactor(1.0 /
// ClimberConstants.kClimberPositionReduction * 2 * Math.PI);
// rightClimberEncoder.setVelocityConversionFactor(1.0 /
// ClimberConstants.kClimberVelocityReduction * 2 * Math.PI);
// }
