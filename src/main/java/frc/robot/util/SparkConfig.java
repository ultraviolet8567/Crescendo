...
/**
 * Utility class to configure a Spark object (either SparkMax or SparkFlex) with standard settings
 */
public class SparkConfig {
    /**
     * Configures the standard settings for a Spark object
     * @param spark Spark object 
     * @param type Type of Spark object
     */
    ...
    public enum SparkType {
        ...
        public int getCurrentLimit() {
            switch(this) {
                case kSparkFlex: return 60;
                case kSparkMax: return 40;
                default: return 40;
            }
        }
    }
